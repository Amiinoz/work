      ...
      <div className="about-container" data-scroll-section>
        <div className="about-container__bio">
          <p data-scroll="" data-offset="2.8">
            ...
            other clients. */}
            a Creative Developer and UX Designer based in Calgary. I have a
            passion for creating user-friendly and visually appealing designs
            that enhance the user experience. With a focus on User Centric
            Design, I strive to create intuitive designs that are easy to use
            for everyone.
          </p>
        </div>
